    ...
    <div class="col-sm-4">
	 ...
	 <div class="spec__item">
          ...
          <p>
            ...
            eye comfort with TUV certified
          </p>
        </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
	 ...
	 <div class="spec__item">
          ...
          <p>
            7700 mAh <br />
            Video playback: up to 12 hrs <br />
            Web browsing: up to 12 hrs
          </p>
        </div>
  ...
  <div class="row ">
    ...
    <div class="col-sm-4">
	  ...
	  <div class="spec__item">
          ...
          <p>
            ...
            B1/B2/B3/B4/B5(B19)/B7/B8/ B20/B28(a+b) TDD LTE : B38/B40/B41 full
            band
          </p>
        </div>
	...
	<div class="spec__item">
          ...
          <p>
            ...
            transfer, charging, and USB Type-C Headset, 4-point Pogo-Pin for
            keyboard connection
          </p>
        </div>
...
<br/><br/><br/><br/><br/>
   ...
   <div class="container-fluid last-header">
      ...
      <br /><br/>
        ...
        *All battery life claims are approximate. Actual battery performance
        will vary and depend on numerous factors including product configuration
        and usage, software, operating conditions, wireless functionality, power
      ...
      <br /><br/>
        ...
        **Water-repellent design creates a barrier to help protect against
        moderate exposure to water such as accidental spills, splashes or light
        rain. Not designed to be submerged in water, or exposed to pressurized
        water, or other liquids; may diminish over time. Not waterproof.
      <br /><br/>

       ^Supports up to 1T microSD card, microSD cards sold separately. Content
        with DRM restrictions may not be able to be moved to the card.
      <br /><br/>

      1 Dolby, Dolby Atmos, and the double-D symbol are registered trademarks
